...
export const messages = {
  [LOCALES.EN_US]: {
    ...
    'dateRange.endAfterToday': 'End date cannot be after today',
    ...
    'global.notFound': 'Page not found',
    'global.older': 'Older',
    ...
    'treeCompare.change.newPasses': 'New passes',
    ...
    'treeCompare.group.builds': 'Architecture',
    'treeCompare.group.tests': 'Path',
    'treeCompare.matrix.boots': 'boots',
    'treeCompare.matrix.builds': 'builds',
    'treeCompare.matrix.fail': 'fail',
    'treeCompare.matrix.fixes': 'fixes',
    'treeCompare.matrix.other': 'other',
