...
# Last updated on 2026-06-01 17:33:18.856293.
    ...
    "build_runs": {
        ...
        "query": """
                ...
                DO UPDATE SET
                    ...
                    output_files = COALESCE(build_runs.output_files, EXCLUDED.output_files),
                    config_url = COALESCE(build_runs.config_url, EXCLUDED.config_url),
                    log_url = COALESCE(build_runs.log_url, EXCLUDED.log_url),
                    log_excerpt = COALESCE(build_runs.log_excerpt, EXCLUDED.log_excerpt),
    ...
    "test_runs": {
        ...
        "query": """
                ...
                DO UPDATE SET
                    ...
                    environment_comment = COALESCE(test_runs.environment_comment, EXCLUDED.environment_comment),
                    environment_misc = COALESCE(test_runs.environment_misc, EXCLUDED.environment_misc),
                    ...
                    log_excerpt = COALESCE(test_runs.log_excerpt, EXCLUDED.log_excerpt),
